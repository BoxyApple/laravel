<div class="col-md-4" data-sticky_column>
                <div class="primary-sidebar">
                    <aside class="widget news-letter">
                        <h3 class="widget-title text-uppercase text-center">Получить Рассылку</h3>
                        @include('admin.errors')
                        <form action="/subscribe" method="post">
                            {{csrf_field()}}
                            <input type="text" class="email" name="email" placeholder="Ваш электронный адрес">
                            <input type="submit" value="Подписаться сейчас" class="text-uppercase text-center btn btn-subscribe">
                        </form>
                        ...
                        <div class="thumb-latest-posts">
                            ...
                            <div class="media">
                                <div class="media-left">
                                    <a href="{{route('post.show', $post->slug)}}" class="popular-img mb-15"><img src="{{$post->getImage()}}" alt="">
