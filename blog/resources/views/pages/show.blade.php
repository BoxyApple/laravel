        ...
        <div class="row">
            <div class="col-md-8">
                <article class="post">
                    ...
                    <div class="post-content">
                        ...
                        <div class="social-share">
							<span
                                    class="social-share-title pull-left text-capitalize">От {{$post->author->name}} в {{$post->getDate()}}</span>
                ...
                <div class="top-comment"><!--top comment-->
                    <img src="{{$post->author->getImage()}}" style="width: 109px;" class="pull-left img-circle" alt="">
                ...
                <div class="leave-comment"><!--leave comment-->
                    ...
                    <form class="form-horizontal contact-form" role="form" method="post" action="/comment">
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
								<textarea class="form-control" rows="6" name="message" placeholder="Сообщение"></textarea>
                            </div>
                        </div>
                        <button class="btn send-btn">Добавить комментарий</button>
                    </form>
